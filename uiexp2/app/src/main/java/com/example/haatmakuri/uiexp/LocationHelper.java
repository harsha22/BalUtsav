...
public class LocationHelper {
	...
	public boolean getLocation(Context context, LocationResult result) {
		...
		if (gps_enabled) {
			...
			lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 60000, 0, locationListenerGps);
		}

		// if network is enabled, get location updates
		if (network_enabled) {
			Log.e(TAG, "network_enabled, requesting updates.");
			lm.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 60000, 0, locationListenerNetwork);
		}
